...
const Table = () => {
  return (
    <div className="w-full flex-col mr-100 md:block hidden">
      ...
      <div className="h-[150px] px-10 py-3 flex items-center justify-between bg-[#1A2438] rounded-2xl border">
        <div className="flex items-center gap-3">
          <div className="bg-[#014eab]  flex justify-center opacity-60  rounded-full w-15 ">
          <RiImageCircleAiLine className="w-10 z-10 text-[#60a5fa] h-15" />
          </div>
          <div className="">
            <h1 className="text-[#2c89fa] mb-1 text-md font-bold">Fast Generation</h1>
            <p className="text-gray-300 text-sm">Fast Timetable generation</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="bg-[#307602e7] flex justify-center opacity-60  rounded-full w-15 ">
            <AiOutlineSafetyCertificate className="w-10 z-10  text-[#66ff00e7] fill-[]  h-15"/>
          
          </div>
          <div>
            <h1 className="text-[#49b700e7] mb-1 text-md font-bold">No conflicts</h1>
            <p className="text-gray-300 text-sm">No timing conflicts found. <br /> Schedule looks perfect</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
